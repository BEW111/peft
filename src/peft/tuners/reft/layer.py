...
def parse_positions(positions: str):
    # Code copied from https://github.com/stanfordnlp/pyreft/pyreft/dataset.py
    # TODO BEW111: make sure everything is correct here, especially since I changed some stuff in my own implementation
    first_n, last_n = 0, 0
    if "+" in positions:
...
class LoReftLayer(nn.Module, LycorisLayer):
    ...
    def merge(self, safe_merge: bool = False, adapter_names: Optional[list[str]] = None) -> None:
        ...
        raise ValueError("ReFT models do not support merging.")
    ...
    def update_layer(
        ...
        **kwargs,
        ...
        TODO BEW111: document other arguments especially `loc`
        """
        if r <= 0:
    ...
    def get_delta_weight(self, adapter_name: str) -> torch.Tensor:
        # Not needed for ReFT
        raise NotImplementedError("ReFT models do not have delta weights.")
