...
class LoReftConfig(LycorisConfig):
    ...
    Args:
        r (`int`): LoReFT rank. Typically takes on similar values to LoRA rank, e.g. 4, 8, etc.
        alpha (`int`): LoReFT alpha.    TODO BEW111: no idea what this is supposed to be? and explain the params in more detail. they asked about it only making sense for language models but we should probably think about this more.
        loc (`Optional[str]`):
        ...
        TODO BEW111: look into adding an `init_weights` argument.
    """
